...
public:
	...
	*/
	UFUNCTION(Category = "Pawn|Components|ProwerMovement", BlueprintCallable)
...
protected:
	...
	*/
	virtual bool StepUp(const FVector& GravDir, const FVector& Delta, const FHitResult &Hit, struct FStepDownResult* OutStepDownResult = NULL) override;
...
protected:
	...
	*/
	UPROPERTY(Category = "Alignment", VisibleAnywhere)
